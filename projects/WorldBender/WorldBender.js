...
/*
To Do: Make these generic:
create some prompts to prompt an art ai to produce pixel art in the 3/4 top down style of classic rpg games on the snes such as chrono trigger and final fantasy 3 such that the art the game is for corresponds to a world with the following world seed:Based on the world seed information provided, here are some prompts to generate pixel art in the classic 3/4 top-down style of SNES RPGs like Chrono Trigger and Final Fantasy III:
